...
void setup() {
  ...
  odrive1.SetPosition(0, 1.02);
  odrive1.SetPosition(1, -0.60);
  delay(50);    
  odrive4.SetPosition(0, -0.5);
  odrive4.SetPosition(1, 1.0);
  delay(5000);
  odrive2.SetPosition(0, 0);
  odrive2.SetPosition(1, 0);
  delay(50);
  odrive3.SetPosition(0, 0);
  odrive3.SetPosition(1, 0);
  delay(50);
  odrive5.SetPosition(0, 0);
  odrive5.SetPosition(1, 0);
  delay(50);
  odrive6.SetPosition(0, 0);
  odrive6.SetPosition(1, 0);
  delay(500000);
} 
...
void loop() {
  ...
  if (now - lastMove > moveDelay) {
    ...
    if (inverseKinematics(x, y, hip_angle_rel, knee_angle_rel)) {
      ...
      // send to ODrive
      // odrive1.SetPosition(0, 1.02);
      // odrive1.SetPosition(1, -0.50);
      // delay(50);

      Serial.print(knee_target_turns);
      Serial.print(" ");
      Serial.println(hip_target_turns);
      odrive2.SetPosition(0, knee_target_turns+0.5);
      odrive2.SetPosition(1,  -hip_target_turns-0.3);
      delay(100);
      // odrive3.SetPosition(0, -knee_target_turns+0.2);
